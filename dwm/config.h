...
/*  Predefine rules without malloc overhead */
static const Rule rules[] = {
    /* No rules defined, but keeping a placeholder for future use */
...
/* P Use static const for layouts */
...
/* Performance optimization: Pre-define command arrays */
